...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'hantree', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '动效设计师', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hantreeblog.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '动效, 博客', // 网站关键词 英文逗号隔开
